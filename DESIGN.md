...
> **v10 核心**：在 v9 基础上，**无库存 / 未定价 / 各类转人工**触发场景统一到 **Lead Routing Engine**——绑定销售优先、无绑定走团队池加权抽签，加入**销售竞争评分**（转化率/吨位/回款/响应/拒单等）+ 配额限制 + SLA + ACK 超时自动转派。
> **v9 微调**：**OCR / 视觉理解统一到通义千问 Qwen-VL 系列**。
...
| 维度 | v3 | v4 | v5 | v6 | v7 | v8 | v9 | **v10** |
|---|---|---|---|---|---|---|---|---|
| 询价输入 | 文字 | 文字/图/Excel/PDF | 同 | 同 | 同 | 同 | 同 | 同 |
| 询价字段 | 5 | 7 | 9 | 同 | 同 | 同 | 同 | 同 |
| NLU 策略 | LLM | LLM | KB+默认+溯源 | 同 | 同 | 同 | 同 | 同 |
| 报价 | 销售单干 | 同 | 同 | 三档协作 | 同 | 同 | 同 | 同 |
| 客户画像 | — | — | 偏好 | 完整画像 | 同 | 同 | 同 | 同 |
| 库存匹配 | — | — | — | 多源组合 | 同 | 同 | 同 | 同 |
| 报价策略 | — | — | — | 11 策略 | 同 | 同 | 同 | 同 |
| 行为干预 | — | — | — | 5 层 | 同 | 同 | 同 | 同 |
| **议价** | — | — | — | — | 多轮状态机 + 让步曲线 | 同 | 同 | 同 |
| **让步货币** | — | — | — | — | 8 维（价/量/时/运/期/质/赠/组） | 同 | 同 | 同 |
| **整单优化** | — | — | — | — | 跨项让步分配 + 整单底线 | 同 + 整单改量校验 | 同 | 同 |
| **议价 LLM** | — | — | — | — | 带预算的议价话术 + 情绪检测 | 同 | 同 | 同 |
| **议价审计** | — | — | — | — | 全轮 offer + 销售决策落库 | 同 | 同 | 同 |
| **报价生命周期**（v8 新） | — | — | — | — | — | **DRAFT/ACTIVE/AMENDING/LOCKED/EXPIRED/SUPERSEDED + 版本化** | 同 | 同 |
| **改量决策**（v8 新） | — | — | — | — | — | **AUTO / ASSISTED / CUSTOMER_CHOICE / MANUAL / REJECT 五档** | 同 | 同 |
| **跌穿 MOQ**（v8 新） | — | — | — | — | — | **客户选项卡片** | 同 | 同 |
| **锁后改量**（v8 新） | — | — | — | — | — | **必走审批工单** | 同 | 同 |
| **改量频次防护**（v8 新） | — | — | — | — | — | **每 Quote / Session / 日多级阈值** | 同 | 同 |
| **视觉 OCR 供应商**（v9 新） | — | — | — | — | — | — | **统一通义千问 Qwen-VL（移除 PaddleOCR / 阿里 / 腾讯 OCR）** | 同 |
| **DashScope 集成**（v9 新） | — | — | — | — | — | — | **企业 SLA + 配额 + 子账号 + 计费监控** | 同 |
| **转人工触发统一**（v10 新） | — | — | — | — | — | — | — | **13 种触发归 Lead Routing Engine** |
| **销售路由两层**（v10 新） | — | — | — | — | — | — | — | **绑定优先 + 团队池加权抽签** |
| **销售评分**（v10 新） | — | — | — | — | — | — | — | **7 维综合 + 团队 leaderboard + 周期更新** |
| **SLA + ACK**（v10 新） | — | — | — | — | — | — | — | **5min ACK / 30min 回客户 / 60min 主管升级** |
| **抽签温度 T**（v10 新） | — | — | — | — | — | — | — | **可后台调节 精英 vs 公平** |
| **配额限制**（v10 新） | — | — | — | — | — | — | — | **每销售每日新单配额 + 新人保底 10%** |
...
继续保留 v3~v8 已有的 1~30 个问题（共 45 个累积）。
